...
namespace PenguinHelper.Tests.ExtensionTests
{
  ...
  public class DoubleExtensionTests
  {
    ...
    /// </summary>
    public class IsZero : FixtureBase
    {
      /// <summary>
    ...
    /// </summary>
    public class IsEqualTo : FixtureBase
    {
      /// <summary>
    ...
    /// </summary>
    public class IsGreaterThan : FixtureBase
    {
      /// <summary>
      ///   Tests that edge cases return true
      /// </summary>
    ...
    /// </summary>
    public class IsGreaterThanOrEqual : FixtureBase
    {
      /// <summary>
    ...
    /// </summary>
    public class IsInfinityTests : FixtureBase
    {
      /// <summary>
    ...
    /// </summary>
    public class LimitToRangeTests : FixtureBase
    {
      /// <summary>
